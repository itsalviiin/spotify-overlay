...
`),new this.minigl.Material(this.vertexShader,this.shaderFiles.fragment,this.uniforms)}initMesh(){this.material=this.initMaterial(),this.geometry=new this.minigl.PlaneGeometry,this.mesh=new this.minigl.Mesh(this.geometry,this.material)}shouldSkipFrame(e){return!!window.document.hidden||!this.conf.playing||parseInt(e,10)%2==0||void 0}updateFrequency(e){this.freqX+=e,this.freqY+=e}toggleColor(e){this.activeColors[e]=this.activeColors[e]===0?1:0}showGradientLegend(){this.width>this.minWidth&&(this.isGradientLegendVisible=!0,document.body.classList.add("isGradientLegendVisible"))}hideGradientLegend(){this.isGradientLegendVisible=!1,document.body.classList.remove("isGradientLegendVisible")}init(){this.initGradientColors(),this.initMesh(),this.resize(),requestAnimationFrame(this.animate),window.addEventListener("resize",this.resize)}waitForCssVars(){if(this.computedCanvasStyle&&this.computedCanvasStyle.getPropertyValue("--gradient-color-1").indexOf("#")!==-1)this.init(),this.addIsLoadedClass();else{if(this.cssVarRetries+=1,this.cssVarRetries>this.maxCssVarRetries)return this.sectionColors=[16711680,16711680,16711935,65280,255],void this.init();requestAnimationFrame(()=>this.waitForCssVars())}}initGradientColors(){this.sectionColors=["--gradient-color-1","--gradient-color-2","--gradient-color-3","--gradient-color-4"].map(e=>{let t=this.computedCanvasStyle.getPropertyValue(e).trim();return t.length===4&&(t=`#${t.substr(1).split("").map(r=>r+r).join("")}`),t&&`0x${t.substr(1)}`}).filter(Boolean).map(de)}}class be{constructor(e,t){this.pixels=e,this.opts=t;const{sigBits:n}=t,r=(_,M,x)=>(_<<2*n)+(M<<n)+x;this.getColorIndex=r;const s=8-n,u=1<<3*n,o=new Uint32Array(u);let d,c,h,a,l,g,m,b,y,p;d=h=l=0,c=a=g=Number.MAX_VALUE;const w=e.length/4;let v=0;for(;v<w;){const _=v*4;if(v++,m=e[_+0],b=e[_+1],y=e[_+2],p=e[_+3],p===0)continue;m=m>>s,b=b>>s,y=y>>s;const M=r(m,b,y);o[M]===void 0&&(o[M]=0),o[M]+=1,m>d&&(d=m),m<c&&(c=m),b>h&&(h=b),b<a&&(a=b),y>l&&(l=y),y<g&&(g=y)}this._colorCount=o.reduce((_,M)=>M>0?_+1:_,0),this.hist=o,this.rmax=d,this.rmin=c,this.gmax=h,this.gmin=a,this.bmax=l,this.bmin=g}get colorCount(){return this._colorCount}}class fe{scaleDown(e){const t=this.getWidth(),n=this.getHeight();let r=1;if(e.maxDimension>0){const s=Math.max(t,n);s>e.maxDimension&&(r=e.maxDimension/s)}else r=1/e.quality;r<1&&this.resize(t*r,n*r,r)}}function ve(i,e){var t;if(e.length>0){const n=i.data,r=n.length/4;let s,u,o,d,c;for(let h=0;h<r;h++){s=h*4,u=n[s+0],o=n[s+1],d=n[s+2],c=n[s+3];for(let a=0;a<e.length;a++)if(!((t=e[a])!=null&&t.call(e,u,o,d,c))){n[s+3]=0;break}}}return i}function ye(i){const e=new URL(i,location.href);return e.protocol===location.protocol&&e.host===location.host&&e.port===location.port}function pe(i,e){const t=new URL(i),n=new URL(e);return t.protocol===n.protocol&&t.hostname===n.hostname&&t.port===n.port}class xe extends fe{_getCanvas(){if(!this._canvas)throw new Error("Canvas is not initialized");return this._canvas}_getContext(){if(!this._context)throw new Error("Context is not initialized");return this._context}_getWidth(){if(!this._width)throw new Error("Width is not initialized");return this._width}_getHeight(){if(!this._height)throw new Error("Height is not initialized");return this._height}_initCanvas(){const e=this.image;if(!e)throw new Error("Image is not initialized");const t=this._canvas=document.createElement("canvas"),n=t.getContext("2d");if(!n)throw new ReferenceError("Failed to create canvas context");this._context=n,t.className="@vibrant/canvas",t.style.display="none",this._width=t.width=e.width,this._height=t.height=e.height,n.drawImage(e,0,0),document.body.appendChild(t)}load(e){let t,n;if(typeof e=="string")t=document.createElement("img"),n=e,!ye(n)&&!pe(window.location.href,n)&&(t.crossOrigin="anonymous"),t.src=n;else if(e instanceof HTMLImageElement)t=e,n=e.src;else return Promise.reject(new Error("Cannot load buffer as an image in browser"));return this.image=t,new Promise((r,s)=>{const u=()=>{this._initCanvas(),r(this)};t.complete?u():(t.onload=u,t.onerror=o=>s(new Error(`Fail to load image: ${n}`)))})}clear(){this._getContext().clearRect(0,0,this._getWidth(),this._getHeight())}update(e){this._getContext().putImageData(e,0,0)}getWidth(){return this._getWidth()}getHeight(){return this._getHeight()}resize(e,t,n){if(!this.image)throw new Error("Image is not initialized");this._width=this._getCanvas().width=e,this._height=this._getCanvas().height=t,this._getContext().scale(n,n),this._getContext().drawImage(this.image,0,0)}getPixelCount(){return this._getWidth()*this._getHeight()}getImageData(){return this._getContext().getImageData(0,0,this._getWidth(),this._getHeight())}remove(){this._canvas&&this._canvas.parentNode&&this._canvas.parentNode.removeChild(this._canvas)}}function N(i,...e){return e.forEach(t=>{if(t){for(const n in t)if(t.hasOwnProperty(n)){const r=t[n];Array.isArray(r)?i[n]=r.slice(0):typeof r=="object"?(i[n]||(i[n]={}),N(i[n],r)):i[n]=r}}}),i}function we(i,e){const{colorCount:t,quantizer:n,generators:r,filters:s}=i,u={colorCount:t},o=typeof n=="string"?{name:n,options:{}}:n;return o.options=N({},u,o.options),N({},{quantizer:o,generators:r,filters:s},e)}class _e{constructor(e,t={}){this._src=e,this._opts=N({},z.DefaultOpts,t)}maxColorCount(e){return this._opts.colorCount=e,this}maxDimension(e){return this._opts.maxDimension=e,this}addFilter(e){return this._opts.filters?this._opts.filters.push(e):this._opts.filters=[e],this}removeFilter(e){if(this._opts.filters){const t=this._opts.filters.indexOf(e);t>0&&this._opts.filters.splice(t)}return this}clearFilters(){return this._opts.filters=[],this}quality(e){return this._opts.quality=e,this}useImageClass(e){return this._opts.ImageClass=e,this}useGenerator(e,t){return this._opts.generators||(this._opts.generators=[]),this._opts.generators.push(t?{name:e,options:t}:e),this}useQuantizer(e,t){return this._opts.quantizer=t?{name:e,options:t}:e,this}build(){return new z(this._src,this._opts)}getPalette(){return this.build().getPalette()}}class G{constructor(e){this.pipeline=e,this._map={}}names(){return Object.keys(this._map)}has(e){return!!this._map[e]}get(e){return this._map[e]}register(e,t){return this._map[e]=t,this.pipeline}}class Ce{constructor(){this.filter=new G(this),this.quantizer=new G(this),this.generator=new G(this)}_buildProcessTasks({filters:e,quantizer:t,generators:n}){return n.length===1&&n[0]==="*"&&(n=this.generator.names()),{filters:e.map(s=>r(this.filter,s)),quantizer:r(this.quantizer,t),generators:n.map(s=>r(this.generator,s))};function r(s,u){let o,d;return typeof u=="string"?o=u:(o=u.name,d=u.options),{name:o,fn:s.get(o),options:d}}}async process(e,t){const{filters:n,quantizer:r,generators:s}=this._buildProcessTasks(t),u=await this._filterColors(n,e),o=await this._generateColors(r,u),d=await this._generatePalettes(s,o);return{colors:o,palettes:d}}_filterColors(e,t){return Promise.resolve(ve(t,e.map(({fn:n})=>n)))}_generateColors(e,t){return Promise.resolve(e.fn(t.data,e.options))}async _generatePalettes(e,t){const n=await Promise.all(e.map(({fn:r,options:s})=>Promise.resolve(r(t,s))));return Promise.resolve(n.reduce((r,s,u)=>(r[e[u].name]=s,r),{}))}}function Le(i,e,t){return"#"+((1<<24)+(i<<16)+(e<<8)+t).toString(16).slice(1,7)}function Se(i,e,t){i/=255,e/=255,t/=255;const n=Math.max(i,e,t),r=Math.min(i,e,t);let s=0,u=0;const o=(n+r)/2;if(n!==r){const d=n-r;switch(u=o>.5?d/(2-n-r):d/(n+r),n){case i:s=(e-t)/d+(e<t?6:0);break;case e:s=(t-i)/d+2;break;case t:s=(i-e)/d+4;break}s/=6}return[s,u,o]}function T(i,e,t){let n,r,s;function u(o,d,c){return c<0&&(c+=1),c>1&&(c-=1),c<1/6?o+(d-o)*6*c:c<1/2?d:c<2/3?o+(d-o)*(2/3-c)*6:o}if(e===0)n=r=s=t;else{const o=t<.5?t*(1+e):t+e-t*e,d=2*t-o;n=u(d,o,i+1/3),r=u(d,o,i),s=u(d,o,i-1/3)}return[n*255,r*255,s*255]}class D{static applyFilters(e,t){return t.length>0?e.filter(({r:n,g:r,b:s})=>{var u;for(let o=0;o<t.length;o++)if(!((u=t[o])!=null&&u.call(t,n,r,s,255)))return!1;return!0}):e}static clone(e){return new D(e._rgb,e._population)}get r(){return this._rgb[0]}get g(){return this._rgb[1]}get b(){return this._rgb[2]}get rgb(){return this._rgb}get hsl(){if(!this._hsl){const[e,t,n]=this._rgb;this._hsl=Se(e,t,n)}return this._hsl}get hex(){if(!this._hex){const[e,t,n]=this._rgb;this._hex=Le(e,t,n)}return this._hex}get population(){return this._population}toJSON(){return{rgb:this.rgb,population:this.population}}getYiq(){if(!this._yiq){const e=this._rgb;this._yiq=(e[0]*299+e[1]*587+e[2]*114)/1e3}return this._yiq}get titleTextColor(){return this._titleTextColor||(this._titleTextColor=this.getYiq()<200?"#fff":"#000"),this._titleTextColor}get bodyTextColor(){return this._bodyTextColor||(this._bodyTextColor=this.getYiq()<150?"#fff":"#000"),this._bodyTextColor}constructor(e,t){this._rgb=e,this._population=t}}const re=class W{constructor(e,t){this._src=e,this.opts=N({},W.DefaultOpts,t)}static use(e){this._pipeline=e}static from(e){return new _e(e)}get result(){return this._result}_process(e,t){e.scaleDown(this.opts);const n=we(this.opts,t);return W._pipeline.process(e.getImageData(),n)}async getPalette(){const e=new this.opts.ImageClass;try{const t=await e.load(this._src),n=await this._process(t,{generators:["default"]});this._result=n;const r=n.palettes.default;if(!r)throw new Error("Something went wrong and a palette was not found, please file a bug against our GitHub repo: https://github.com/vibrant-Colors/node-vibrant/");return e.remove(),r}catch(t){return e.remove(),Promise.reject(t)}}async getPalettes(){const e=new this.opts.ImageClass;try{const t=await e.load(this._src),n=await this._process(t,{generators:["*"]});this._result=n;const r=n.palettes;return e.remove(),r}catch(t){return e.remove(),Promise.reject(t)}}};re.DefaultOpts={colorCount:64,quality:5,filters:[]};let z=re;z.DefaultOpts.quantizer="mmcq";z.DefaultOpts.generators=["default"];z.DefaultOpts.filters=["default"];z.DefaultOpts.ImageClass=xe;const Y=5,j=8-Y;class q{constructor(e,t,n,r,s,u,o){this.histogram=o,this._volume=-1,this._avg=null,this._count=-1,this.dimension={r1:e,r2:t,g1:n,g2:r,b1:s,b2:u}}static build(e){const t=new be(e,{sigBits:Y}),{rmin:n,rmax:r,gmin:s,gmax:u,bmin:o,bmax:d}=t;return new q(n,r,s,u,o,d,t)}invalidate(){this._volume=this._count=-1,this._avg=null}volume(){if(this._volume<0){const{r1:e,r2:t,g1:n,g2:r,b1:s,b2:u}=this.dimension;this._volume=(t-e+1)*(r-n+1)*(u-s+1)}return this._volume}count(){if(this._count<0){const{hist:e,getColorIndex:t}=this.histogram,{r1:n,r2:r,g1:s,g2:u,b1:o,b2:d}=this.dimension;let c=0;for(let h=n;h<=r;h++)for(let a=s;a<=u;a++)for(let l=o;l<=d;l++){const g=t(h,a,l);e[g]&&(c+=e[g])}this._count=c}return this._count}clone(){const{histogram:e}=this,{r1:t,r2:n,g1:r,g2:s,b1:u,b2:o}=this.dimension;return new q(t,n,r,s,u,o,e)}avg(){if(!this._avg){const{hist:e,getColorIndex:t}=this.histogram,{r1:n,r2:r,g1:s,g2:u,b1:o,b2:d}=this.dimension;let c=0;const h=1<<8-Y;let a,l,g;a=l=g=0;for(let m=n;m<=r;m++)for(let b=s;b<=u;b++)for(let y=o;y<=d;y++){const p=t(m,b,y),w=e[p];w&&(c+=w,a+=w*(m+.5)*h,l+=w*(b+.5)*h,g+=w*(y+.5)*h)}c?this._avg=[~~(a/c),~~(l/c),~~(g/c)]:this._avg=[~~(h*(n+r+1)/2),~~(h*(s+u+1)/2),~~(h*(o+d+1)/2)]}return this._avg}contains(e){let[t,n,r]=e;const{r1:s,r2:u,g1:o,g2:d,b1:c,b2:h}=this.dimension;return t>>=j,n>>=j,r>>=j,t>=s&&t<=u&&n>=o&&n<=d&&r>=c&&r<=h}split(){const{hist:e,getColorIndex:t}=this.histogram,{r1:n,r2:r,g1:s,g2:u,b1:o,b2:d}=this.dimension,c=this.count();if(!c)return[];if(c===1)return[this.clone()];const h=r-n+1,a=u-s+1,l=d-o+1,g=Math.max(h,a,l);let m=null,b,y;b=y=0;let p=null;if(g===h){p="r",m=new Uint32Array(r+1);for(let x=n;x<=r;x++){b=0;for(let C=s;C<=u;C++)for(let L=o;L<=d;L++){const E=t(x,C,L);e[E]&&(b+=e[E])}y+=b,m[x]=y}}else if(g===a){p="g",m=new Uint32Array(u+1);for(let x=s;x<=u;x++){b=0;for(let C=n;C<=r;C++)for(let L=o;L<=d;L++){const E=t(C,x,L);e[E]&&(b+=e[E])}y+=b,m[x]=y}}else{p="b",m=new Uint32Array(d+1);for(let x=o;x<=d;x++){b=0;for(let C=n;C<=r;C++)for(let L=s;L<=u;L++){const E=t(C,L,x);e[E]&&(b+=e[E])}y+=b,m[x]=y}}let w=-1;const v=new Uint32Array(m.length);for(let x=0;x<m.length;x++){const C=m[x];C&&(w<0&&C>y/2&&(w=x),v[x]=y-C)}const _=this;function M(x){const C=x+"1",L=x+"2",E=_.dimension[C];let S=_.dimension[L];const Q=_.clone(),J=_.clone(),Z=w-E,ee=S-w;for(Z<=ee?(S=Math.min(S-1,~~(w+ee/2)),S=Math.max(0,S)):(S=Math.max(E,~~(w-1-Z/2)),S=Math.min(_.dimension[L],S));!m[S];)S++;let te=v[S];for(;!te&&m[S-1];)te=v[--S];return Q.dimension[L]=S,J.dimension[C]=S+1,[Q,J]}return M(p)}}class ne{_sort(){this._sorted||(this.contents.sort(this._comparator),this._sorted=!0)}constructor(e){this._comparator=e,this.contents=[],this._sorted=!1}push(e){this.contents.push(e),this._sorted=!1}peek(e){return this._sort(),e=typeof e=="number"?e:this.contents.length-1,this.contents[e]}pop(){return this._sort(),this.contents.pop()}size(){return this.contents.length}map(e){return this._sort(),this.contents.map(e)}}const Me=.75;function ie(i,e){let t=i.size();for(;i.size()<e;){const n=i.pop();if(n&&n.count()>0){const[r,s]=n.split();if(!r||(i.push(r),s&&s.count()>0&&i.push(s),i.size()===t))break;t=i.size()}else break}}const De=(i,e)=>{if(i.length===0||e.colorCount<2||e.colorCount>256)throw new Error("Wrong MMCQ parameters");const t=q.build(i);t.histogram.colorCount;const n=new ne((s,u)=>s.count()-u.count());n.push(t),ie(n,Me*e.colorCount);const r=new ne((s,u)=>s.count()*s.volume()-u.count()*u.volume());return r.contents=n.contents,ie(r,e.colorCount-r.size()),Ve(r)};function Ve(i){const e=[];for(;i.size();){const t=i.pop(),n=t.avg(),[r,s,u]=n;e.push(new D(n,t.count()))}return e}const Ae={targetDarkLuma:.26,maxDarkLuma:.45,minLightLuma:.55,targetLightLuma:.74,minNormalLuma:.3,targetNormalLuma:.5,maxNormalLuma:.7,targetMutesSaturation:.3,maxMutesSaturation:.4,targetVibrantSaturation:1,minVibrantSaturation:.35,weightSaturation:3,weightLuma:6.5,weightPopulation:.5};function Ee(i){let e=0;return i.forEach(t=>{e=Math.max(e,t.population)}),e}function Ie(i,e){return i.Vibrant===e||i.DarkVibrant===e||i.LightVibrant===e||i.Muted===e||i.DarkMuted===e||i.LightMuted===e}function Te(i,e,t,n,r,s,u){function o(...c){let h=0,a=0;for(let l=0;l<c.length;l+=2){const g=c[l],m=c[l+1];!g||!m||(h+=g*m,a+=m)}return h/a}function d(c,h){return 1-Math.abs(c-h)}return o(d(i,e),u.weightSaturation,d(t,n),u.weightLuma,r/s,u.weightPopulation)}function U(i,e,t,n,r,s,u,o,d,c){let h=null,a=0;return e.forEach(l=>{const[,g,m]=l.hsl;if(g>=o&&g<=d&&m>=r&&m<=s&&!Ie(i,l)){const b=Te(g,u,m,n,l.population,t,c);(h===null||b>a)&&(h=l,a=b)}}),h}function ze(i,e,t){const n={Vibrant:null,DarkVibrant:null,LightVibrant:null,Muted:null,DarkMuted:null,LightMuted:null};return n.Vibrant=U(n,i,e,t.targetNormalLuma,t.minNormalLuma,t.maxNormalLuma,t.targetVibrantSaturation,t.minVibrantSaturation,1,t),n.LightVibrant=U(n,i,e,t.targetLightLuma,t.minLightLuma,1,t.targetVibrantSaturation,t.minVibrantSaturation,1,t),n.DarkVibrant=U(n,i,e,t.targetDarkLuma,0,t.maxDarkLuma,t.targetVibrantSaturation,t.minVibrantSaturation,1,t),n.Muted=U(n,i,e,t.targetNormalLuma,t.minNormalLuma,t.maxNormalLuma,t.targetMutesSaturation,0,t.maxMutesSaturation,t),n.LightMuted=U(n,i,e,t.targetLightLuma,t.minLightLuma,1,t.targetMutesSaturation,0,t.maxMutesSaturation,t),n.DarkMuted=U(n,i,e,t.targetDarkLuma,0,t.maxDarkLuma,t.targetMutesSaturation,0,t.maxMutesSaturation,t),n}function Ue(i,e,t){if(!i.Vibrant&&!i.DarkVibrant&&!i.LightVibrant){if(!i.DarkVibrant&&i.DarkMuted){let[n,r,s]=i.DarkMuted.hsl;s=t.targetDarkLuma,i.DarkVibrant=new D(T(n,r,s),0)}if(!i.LightVibrant&&i.LightMuted){let[n,r,s]=i.LightMuted.hsl;s=t.targetDarkLuma,i.DarkVibrant=new D(T(n,r,s),0)}}if(!i.Vibrant&&i.DarkVibrant){let[n,r,s]=i.DarkVibrant.hsl;s=t.targetNormalLuma,i.Vibrant=new D(T(n,r,s),0)}else if(!i.Vibrant&&i.LightVibrant){let[n,r,s]=i.LightVibrant.hsl;s=t.targetNormalLuma,i.Vibrant=new D(T(n,r,s),0)}if(!i.DarkVibrant&&i.Vibrant){let[n,r,s]=i.Vibrant.hsl;s=t.targetDarkLuma,i.DarkVibrant=new D(T(n,r,s),0)}if(!i.LightVibrant&&i.Vibrant){let[n,r,s]=i.Vibrant.hsl;s=t.targetLightLuma,i.LightVibrant=new D(T(n,r,s),0)}if(!i.Muted&&i.Vibrant){let[n,r,s]=i.Vibrant.hsl;s=t.targetMutesSaturation,i.Muted=new D(T(n,r,s),0)}if(!i.DarkMuted&&i.DarkVibrant){let[n,r,s]=i.DarkVibrant.hsl;s=t.targetMutesSaturation,i.DarkMuted=new D(T(n,r,s),0)}if(!i.LightMuted&&i.LightVibrant){let[n,r,s]=i.LightVibrant.hsl;s=t.targetMutesSaturation,i.LightMuted=new D(T(n,r,s),0)}}const ke=(i,e)=>{e=Object.assign({},Ae,e);const t=Ee(i),n=ze(i,t,e);return Ue(n,t,e),n},Be=new Ce().filter.register("default",(i,e,t,n)=>n>=125&&!(i>250&&e>250&&t>250)).quantizer.register("mmcq",De).generator.register("default",ke);z.use(Be);console.log("Spotify Overlay [v1.1.1]");const Fe=window.location.search,I=new URLSearchParams(Fe),X=I.get("client_id")||"",oe=I.get("client_secret")||"";let Oe=I.get("refresh_token")||"",ae="";const R=I.get("duration")||0,Ne=I.has("hide_album_art"),Re=I.has("hide_times"),$e=I.get("text_scroll")||"ease-in-out",$=I.get("enable_canvas")||"false";var le=!1,H="",K="",B=!0,P=null;const Pe=/(?:(?:featuring|with|feat\.?|by)\s+|-\s+|\[\s+)(.*?)(?:\)|\]|\s+remix\]|\s+remix|$)/i,V=document.getElementById("albumArt"),A=document.getElementById("videoCanvas");var O=new ge;O.seed=Number(I.get("gradient_seed"))||Math.floor(Math.random()*1e4);O.amp=Number(I.get("gradient_amp"))||300;async function ce(){let i=`grant_type=refresh_token&refresh_token=${Oe}&client_id=${X}`;const e=await fetch("https://accounts.spotify.com/api/token",{method:"POST",headers:{Authorization:`Basic ${btoa(X+":"+oe)}`,"Content-Type":"application/x-www-form-urlencoded"},body:i});e.ok&&(ae=(await e.json()).access_token)}async function qe(){try{const i=await fetch("https://api.spotify.com/v1/me/player/currently-playing",{method:"GET",headers:{Authorization:`Bearer ${ae}`,"Content-Type":"application/json"}});if(i.ok){const e=await i.json();Ge(e)}else i.status===401&&await ce()}catch{k(!1)}}async function Ge(i){var e=i.is_playing,t=i.item.uri,n=`${i.item.duration_ms/1e3}`,r=`${i.progress_ms/1e3}`;e!==le&&(e?setTimeout(()=>{A.play(),O.play(),k(!0),R>0&&setTimeout(()=>{k(!1,!1)},R*1e3)},500):(k(!1),setTimeout(()=>{s.classList.remove("animate"),s.style.transform="translateX(0)",O.pause(),A.pause()},500)));var s=document.getElementById("topInfo");if(t!==H&&e){P&&(clearTimeout(P),P=null),setTimeout(()=>{k(!0),R>0&&setTimeout(()=>{k(!1,!1)},R*1e3)},500),H=t,s.classList.remove("animate"),s.style.transform="translateX(0)";var u=i.item.name,o,d=u.match(Pe);if(d){let v=d[1].toLowerCase();var c=[i.item.artists[0].name];if(i.item.artists.length>1)for(const _ of i.item.artists.slice(1))v.includes(_.name.toLowerCase())||c.push(_.name);o=c.join(", ")}else o=i.item.artists.map(v=>v.name).join(", ");if(i.item.is_local){let v=i.item.name.split(" - ");u=v[0],o=v[1]}var h=i.item.album.images.length>0?`${i.item.album.images[0].url}`:"./src/images/album-art-placeholder.png";Je(h),z.from(h).getPalette().then(function(v){document.getElementById("progressBar").style.backgroundColor=ue(v.Vibrant.hex)<=.02?F(v.Vibrant.hex,20):v.Vibrant.hex,document.getElementById("progressBg").style.backgroundColor=Ye(v.Vibrant.hex),document.getElementById("progressTime").style.color=v.LightVibrant.hex,document.getElementById("endTime").style.color=v.LightVibrant.hex,document.getElementById("dotSeparator").style.color=v.Muted.hex,document.getElementById("songLabel").style.color=v.LightVibrant.hex,document.getElementById("artistLabel").style.color=v.LightMuted.hex,O.initGradient("#gradient-canvas");const _=document.querySelector("#gradient-canvas"),M={"--gradient-color-1":`${v.DarkMuted.hex}`,"--gradient-color-2":`${F(v.Vibrant.hex,-10)}`,"--gradient-color-3":`${F(v.LightVibrant.hex,-20)}`,"--gradient-color-4":`${F(v.DarkMuted.hex,-5)}`,"--gradient-speed":"0.000009"};for(const[x,C]of Object.entries(M))_.style.setProperty(x,C)}),je(u),He(o),($==="true"||$==="always"||$==="swap")&&(K=await Ke(H.split(":")[2]),Qe(K),$==="swap"&&(B=!0,he()))}if(s.scrollWidth>s.clientWidth){s.classList.add("animate");var a=s.scrollWidth-s.clientWidth,l=Math.round(s.scrollWidth/500),g=l<1?10:(l-1)*5+10,m=20-(l-1)*5>5?20-(l-1)*5:5,b=80+(l-1)*5<95?80+(l-1)*5:95;const v=document.getElementById("scroll-style")||document.createElement("style");v.id="scroll-style",v.textContent=`
